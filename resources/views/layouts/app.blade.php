...
<head>
    ...
    <title>{{ config('app.name', 'Laravel 7.X User Roles and Permissions Tutorial') }}</title><!-- Scripts -->
...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container"><a class="navbar-brand" href="{{ url('/') }}">Laravel 7.X User Roles and Permissions -
                rscoder.com</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent"><!-- Left Side Of Navbar -->
                ...
                <ul class="navbar-nav ml-auto"><!-- Authentication Links -->@guest
